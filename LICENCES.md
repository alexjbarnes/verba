...
- **nlprule English rule/tokenizer binaries** (`src-tauri/data/nlprule/`) —
  built from [LanguageTool](https://languagetool.org) rules
  (**LGPL-2.1-or-later**) via [nlprule](https://github.com/bminixhofer/nlprule)
  (MIT/Apache-2.0).
